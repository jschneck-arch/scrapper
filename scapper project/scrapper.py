...
def get_auth_session(url, username, password):
...
def scrape(keyword, url, username='', password=''):
    session = get_auth_session(url, username, password) if username and password else requests.Session()
